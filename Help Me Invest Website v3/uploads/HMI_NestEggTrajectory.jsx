...
function homeInterestSchedule(balance, annualRatePct, years, isIO) {
  ...
  const termMonths = 25 * 12; // assumed remaining term
...
function Btn({ children, onClick, variant = "secondary", onEmerald }) {
  ...
  return (
    <button
      onClick={onClick}
      style={{ padding: "13px 26px", borderRadius: 999, fontFamily: F.body, fontWeight: 500, fontSize: 15, cursor: "pointer", transition: `transform .3s ${EASE}, background .9s ${EASE}`, ...style }}
    >
      {children}
    </button>
  );
...
export default function NestEggTrajectory() {
  ...
  const props = { d, set, calc, next, setInv, addInv, removeInv };
  ...
  return (
    <div style={{ fontFamily: F.body, background: C.paper, color: C.charcoal, minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <header style={{ position: "sticky", top: 0, zIndex: 10, background: C.paper, borderBottom: `1px solid ${C.grey}40` }}>
        <div style={{ maxWidth: 760, margin: "0 auto", padding: "18px 24px 0" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
            <Lockup />
            <span style={{ fontFamily: F.body, fontWeight: 500, fontSize: 12, letterSpacing: "0.02em", textTransform: "uppercase", color: C.grey }}>
              {screen.phase}
            </span>
          </div>
          {/* phase segments */}
      ...
      <main style={{ flex: 1, overflowY: "auto" }}>
        <div key={screen.key} className="screenIn" style={{ maxWidth: 760, margin: "0 auto", padding: "36px 24px 40px" }}>
      ...
      <footer style={{ position: "sticky", bottom: 0, zIndex: 10, background: C.paper, borderTop: `1px solid ${C.grey}40` }}>
        <div style={{ maxWidth: 760, margin: "0 auto", padding: "16px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16 }}>
...
function ScreenNetWorth({ d, calc }) {
  ...
  return (
    <div>
      ...
      />
      <div style={{ background: C.emerald, borderRadius: 24, padding: "30px 28px", marginBottom: 24 }}>
  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 18 }}>
        <div style={{ background: C.lighterMint, borderRadius: 24, padding: "24px 24px 20px" }}>
          ...
          <div className="news-h2" style={{ fontFamily: F.display, fontWeight: 400, fontSize: 36, color: C.negative, lineHeight: 1, marginBottom: 14 }}>−{fmtK(calc.homeInt.total)}</div>
        ...
        <div style={{ background: C.lighterMint, borderRadius: 24, padding: "24px 24px 20px" }}>
          ...
          <div className="news-h2" style={{ fontFamily: F.display, fontWeight: 400, fontSize: 36, color: C.negative, lineHeight: 1, marginBottom: 14 }}>−{fmtK(calc.taxTotal)}</div>
...
function ScreenCost({ calc }) {
  return (
    <div>
      ...
      />
      <div style={{ background: C.lighterMint, borderRadius: 24, padding: "10px 24px 18px", marginBottom: 24 }}>
  ...
  return (
    <div>
      <ScreenHead
        ...
        title="Right now, you don't have a plan"
        emphasis="don't have a plan"
        lede="No passive income trajectory. No portfolio building underneath you. Here's what the numbers actually look like when retirement comes — and what selling the home does and doesn't do."
      />

      {/* The hard line */}
      <div style={{ background: C.negative, borderRadius: 24, padding: "30px 28px", marginBottom: 24, color: C.paper }}>
        ...
        <div className="news-h1" style={{ fontFamily: F.display, fontWeight: 400, fontSize: 36, color: C.paper, lineHeight: 1.15, marginBottom: 14 }}>
          You are nowhere near being able to retire on your current path.
        </div>
      ...
      <div style={{ background: C.lighterMint, borderRadius: 24, padding: "8px 24px 18px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", padding: "14px 0" }}>
          ...
          <span className="news-h2" style={{ fontFamily: F.display, fontWeight: 400, fontSize: 34, color: C.emerald }}>{fmtK(calc.totalCapitalAtRetirement)}</span>
        </div>
      </div>

      {/* How long it lasts */}
      <div style={{ background: C.mint, borderRadius: 24, padding: "26px 28px", marginTop: 20 }}>
        ...
        <p style={{ fontFamily: F.body, fontSize: 15, lineHeight: 1.65, color: C.emerald, margin: "16px 0 0", maxWidth: 560 }}>
          {lastsWhole < 15
            ? <>That's it. Most Australians retiring at {d.retireAge} live another 25–30 years. The maths runs out long before you do.</>
            : lastsWhole < 25
      ...
      {d.ownsHome === "yes" && (
        <div style={{ background: C.lighterMint, borderRadius: 24, padding: "26px 28px", marginTop: 20 }}>
          ...
          {calc.shortfallVsMedianCity > 0 ? (
            <div style={{ background: C.negative, color: C.paper, borderRadius: 14, padding: "16px 18px", marginTop: 14 }}>
              ...
              <div style={{ fontFamily: F.body, fontSize: 14, lineHeight: 1.55, opacity: 0.95 }}>
                What are you really downgrading to? A regional town further from family? A small unit on the outskirts? This is the part of the conversation nobody has — until they're standing at the auction with the cheque in their hand.
              </div>
            </div>
          ) : (
      ...
      {/* The bottom line */}
      <div style={{ background: C.negative, color: C.paper, borderRadius: 24, padding: "30px 28px", marginTop: 24 }}>
        <h3 className="news-h3" style={{ fontFamily: F.display, fontWeight: 400, fontSize: 26, color: C.paper, margin: "0 0 14px" }}>This is unsustainable.</h3>
        <p style={{ fontFamily: F.body, fontSize: 16, lineHeight: 1.7, color: C.paper, opacity: 0.95, margin: 0 }}>
          With today's cost of living, the path you're on doesn't reach a real retirement. Super alone never has. Selling the home gives you a one-off lump, but the maths above shows what that actually buys. Without a plan that builds passive income alongside what you already have, you're in the red — and time only sharpens that.
        </p>
        <p style={{ fontFamily: F.body, fontSize: 16, lineHeight: 1.7, color: C.paper, opacity: 0.95, marginTop: 14, marginBottom: 0 }}>
          The next screens show what a different path could look like. The choice is yours — but at least now you can see what you're choosing between.
        </p>
      </div>
      ...
      <div style={{ background: C.mint, borderRadius: 24, padding: "26px 28px", marginTop: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 18 }}>
          <div>
            ...
            <div className="news-h1" style={{ fontFamily: F.display, fontWeight: 400, fontSize: 44, color: C.emerald, lineHeight: 1, marginTop: 6 }}>{fmt(calc.needTotal)}<span style={{ fontSize: 17, opacity: 0.7 }}> / yr</span></div>
          </div>
          <div style={{ textAlign: "right" }}>
            ...
            <div className="news-h2" style={{ fontFamily: F.display, fontWeight: 400, fontSize: 32, color: C.emerald, lineHeight: 1, marginTop: 6 }}>{fmtK(calc.trajectoryPassive)}<span style={{ fontSize: 15, opacity: 0.7 }}> / yr</span></div>
          </div>
        </div>
        {calc.incomeGap > 0 && (
  ...
  return (
    <div>
      ...
      <div style={{ background: C.emerald, borderRadius: 24, padding: "30px 28px", marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", gap: 28, flexWrap: "wrap", alignItems: "flex-end" }}>
          <div>
            <div className="news-d" style={{ fontFamily: F.display, fontWeight: 400, fontSize: 56, color: C.paper, lineHeight: 1 }}>{fmtK(pool)}</div>
        ...
        <div style={{ display: "flex", gap: 28, flexWrap: "wrap", marginTop: 22, paddingTop: 20, borderTop: `1px solid ${C.paper}33` }}>
          <div>
            ...
            <div className="news-h2" style={{ fontFamily: F.display, fontWeight: 400, fontSize: 30, color: C.paper, lineHeight: 1 }}>{fmtK(calc.borrowingCapacity)}</div>
          ...
          <div>
            ...
            <div className="news-h2" style={{ fontFamily: F.display, fontWeight: 400, fontSize: 30, color: C.paper, lineHeight: 1 }}>{fmtK(calc.borrowingHeadroom)}</div>
      ...
      {propsAcquired > 0 ? (
        ...
        <div style={{ background: C.lighterMint, borderRadius: 24, padding: "26px 28px" }}>
      ...
      {plan.buyYears.length > 1 && (
        <div style={{ background: C.lighterMint, borderRadius: 24, padding: "24px 26px", marginTop: 20 }}>
      ...
      <div style={{ background: C.mint, borderRadius: 24, padding: "26px 28px", marginTop: 20 }}>
        ...
        <div style={{ display: "flex", gap: 28, flexWrap: "wrap" }}>
          ...
          <div>
            <div className="news-h2" style={{ fontFamily: F.display, fontWeight: 400, fontSize: 34, color: C.emerald, lineHeight: 1 }}>{fmtK(calc.ngRent)}</div>
...
function ScreenPlan({ d, set, calc }) {
  ...
  return (
    <div>
      ...
      />
      <div style={{ background: C.emerald, borderRadius: 24, padding: "40px 28px", textAlign: "center", marginBottom: 24 }}>
        ...
        <div className="news-d" style={{ fontFamily: F.display, fontWeight: 400, fontSize: 88, color: C.paper, lineHeight: 0.95 }}>{calc.propertiesNeeded}</div>
      ...
      {calc.totalUsableEquity80 > 0 && (
        <>
          ...
          <div style={{ background: C.lighterMint, borderRadius: 24, padding: "10px 24px 18px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", padding: "14px 0 8px" }}>
              ...
              <span className="news-h3" style={{ fontFamily: F.display, fontWeight: 400, fontSize: 30, color: C.emerald }}>{fmtK(calc.totalUsableEquity80)}</span>
            </div>
          </div>
      ...
      <div style={{ background: C.lighterMint, borderRadius: 24, padding: "28px 28px", marginTop: 16 }}>
...
function ScreenTerms({ d, calc }) {
  ...
  return (
    <div>
      ...
      <div style={{ background: C.lighterMint, borderRadius: 24, padding: "8px 24px 12px" }}>
